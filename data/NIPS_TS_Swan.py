...
class NIPS_TS_Swan(Dataset):
    """
    NIPS_TS_Swan Dataset.
    """
    base_folder = ''

    def __init__(self, fname, root=MyPath.db_root_dir('nips_ts_swan'), train=True, transform=None, sanomaly=None,
                 mean_data=None, std_data=None):
        super(NIPS_TS_Swan, self).__init__()
        self.root = root
        ...
        train_data_path = os.path.join(self.root, "NIPS_TS_Swan_train.npy")
        ...
        if self.train:
            ...
            test_data_path = os.path.join(self.root, "NIPS_TS_Swan_test.npy")
            ...
            label_path = os.path.join(self.root, "NIPS_TS_Swan_test_label.npy")
